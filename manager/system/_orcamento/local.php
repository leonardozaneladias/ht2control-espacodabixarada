...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="bs-callout bs-callout-default">
            <h4>Local</h4>
            <p>Neste módulo você adicionais locais ao seu orçamento</p>
        </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php
        $Read = new Read;
        $Read->FullRead("SELECT app_tipoevento.tipoevento_nome, app_orcamento_tipoeventos.tipoevento_id FROM app_orcamento_tipoeventos LEFT OUTER JOIN app_tipoevento ON app_orcamento_tipoeventos.tipoevento_id = app_tipoevento.tipoevento_id WHERE app_orcamento_tipoeventos.orcamento_id = :id", "id={$orcamentoId}");
        if ($Read->getResult()):
                        ...
                        if ($Admin->buscarLocal($orcamentoId, $tipoevento_id)):
                            ...
                            echo '
                                <div class="col-md-12 text-center">
                                    <button data-id="'.$tipoevento_id.'"
                                            class="btn btn-primary btn-block AjaxSelecionaLocais">
                                        Adicionar
                                    </button>
                                </div>
                            ';
