...
if(!$data):
    ...
    $dataGet = filter_input(INPUT_GET, "id", FILTER_VALIDATE_INT);
    //var_dump($dataGet);
    include_once("_models/AdminComissao.class.php");
    $Comissao = new AdminComissao();
    $Retorno = $Comissao->getComissao($dataGet);


    $data = $Retorno['ComissaoData'][0];
    $CursosRetorno = $Retorno['ComissaoCursos'];
    $IntegrantesRetorno = $Retorno['ComissaoIntegrantes'];


    //var_dump($IntegrantesRetorno);
endif;
?>
    ...
    <div class="col-lg-12" id="crop-avatar">
        ...
        <form class="form-horizontal" method="post" name="form_tipoevento" enctype="multipart/form-data">
            <fieldset>
                ...
                if (isset($data['Atualizat'])):
                    unset($data['Atualizat']);
                    //($data);
                   ...
                   // var_dump($retorno);
                    ...
                    <div class="col-md-12" style="margin-top: 20px; margin-bottom: -10px;">
                        <table class="table table-bordered" id="adicionaComissao">
                            ...
                            <tbody>
                            <?php
                            //var_dump($CursosRetorno);
                            foreach ($CursosRetorno as $Values):
                                extract($Values);
                                    ...
                                    <td>
                                        <select class="form-control selectCampus" name="comissao_campus[]">
                                            ...
                                            foreach ($retorno['campus'] as $id => $campus):
                                                $Selected = ($campus_id == $id ? "selected" : "");
                                                ?>
                                                <option
                                                    value="<?= $id ?>" <?= $Selected ?>>
                                                    <?= $campus ?></option>
                                    ...
                                    <td>
                                        <select class="form-control" name="comissao_periodo[]">
                                            ...
                                            foreach ($PERIODO as $id => $periodo):
                                                $Selected = ($periodo_id == $id ? "selected" : "");
                ...
                <div class="col-md-12" style="margin-top: 20px; margin-bottom: -10px;">
                    <table class="table table-bordered" id="adicionaIntegrante">
                        ...
                        <tbody>
                        <?php
                        if (count($IntegrantesRetorno) > 0):
                            foreach ($IntegrantesRetorno as $Values):
                                extract($Values);
                                ?>
                                <input type="hidden" name="integrante_nome[<?=$integrante_id?>]"
                                       value="<?=$integrante_id?>" class="form-control">
                                <tr>
                                    <td>
                                        <input type="text" name="integrante_nome[<?=$integrante_id?>]"
                                               value="<?=$integrante_nome?>" class="form-control">
                                    </td>
                                    <td>
                                        <input type="email" name="integrante_email[<?=$integrante_id?>]"
                                               value="<?=$integrante_email?>" class="form-control">
                                    </td>
                                    <td>
                                        <input type="telefone" name="integrante_telefone[<?=$integrante_id?>]"
                                               value="<?=$integrante_telefone?>" class="form-control">
                                    </td>
                                    <td>
