...
<div class="row row-centered">
    <div class="col-lg-12" id="crop-avatar">
        ...
        <div class="avatar-view" title="Change the avatar">
            ...
            <img src="<?php if(!empty($data['categoria_img'])){echo $data['categoria_img'];}else{echo "../uploads/avatar/avatar.jpg";}?>" alt="Avatar">
        </div>
        ...
        <form class="form-horizontal" method="post" name="form_tipoevento" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" name="categoria_posicao"
                           value="<?php if (isset($data['categoria_posicao'])) {
                               echo $data['categoria_posicao'];
                           } ?>">
                </div>
                <div class="col-md-6">
