<div class="row">
    <div class="col-lg-12 bs-callout bs-callout-default">
        ...
        <div class="col-lg-2">
            <a href="painel.php?exe=comissao/create" title="Cadastrar Novo" class="btn btn-primary">Cadastrar Nova Comissão</a>
        </div>
    </div>
        ...
        if ($read->getResult()):
            foreach ($read->getResult() as $categoria):
                ...
                <tr id="id_mark_<?= $categoria_id; ?>">
                    ...
                    <td><?= $categoria_posicao; ?></td>
                    <td><?= $STATUS[$categoria_status]; ?></td>
                    <td>
                        <a href="painel.php?exe=comissao/update&id=<?= $categoria_id; ?>"><i
                                class="glyphicon glyphicon-edit" style="font-size: 18px;"></i></a>
                        <a href="painel.php?exe=comissao/index&delete=<?= $categoria_id; ?>" style="font-size: 18px;"><i
