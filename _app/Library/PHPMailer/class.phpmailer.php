...
|   Authors: Andy Prevost (codeworxtech) codeworxtech@usuario.sourceforge.net |
|          : Marcus Bointon (coolbru) coolbru@usuario.sourceforge.net         |
 ...
 */
   ...
   * the older validation method for those usuario. (http://php.net/manual/en/pcre.installation.php)
